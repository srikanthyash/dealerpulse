...
def render_header(subtitle = ""):
    ...
    with header_col3:
        ...
        <div style="display: flex; align-items: center; justify-content: flex-end; gap: 12px; height: 100%;">
            <img src="https://th.bing.com/th/id/OIP.Vy1yFQtg8-D1SsAxcqqtSgHaE6?w=235&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3%22" alt="YASH logo" style='height:64px; width:auto; object-fit:contain;' />
